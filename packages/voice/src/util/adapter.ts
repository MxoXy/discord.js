...
/**
 * Methods that are provided by the \@draftbot/voice library to implementations of
...
export interface DiscordGatewayAdapterImplementerMethods {
	/**
	 * This will be called by \@draftbot/voice when the adapter can safely be destroyed as it will no
	 * longer be used.
	 */
	destroy(): void;
	/**
